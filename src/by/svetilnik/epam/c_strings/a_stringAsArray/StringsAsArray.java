package by.svetilnik.epam.c_strings.a_stringAsArray;
...
public class StringsAsArray {
    ...
    public static void task1(String[] camelCase) {
    ...
    public static void task2(String string, String replaceableWord, String wordToReplace) {
